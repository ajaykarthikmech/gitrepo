...
# ===========================================================================
HOST = "ajaykarthik"   # shown as  ajaykarthik@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Freelance AI/Automation Dev, MX-Hub"),
    ("kv", "Prev", "Maint. Eng Intern, Ashok Leyland"),
    ("kv", "Also", "Robotics Club PTU \u2014 Event Coord."),
    ("kv", "Edu", "B.Tech Mechatronics, PTU '27"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Automation", "Allen-Bradley, Siemens, SCADA, DCS"),
    ("kv", "Comms", "Ethernet/IP, Modbus, OPC-UA, MQTT"),
    ("kv", "Vision/AI", "OpenCV, YOLOv8/11, PyTorch"),
    ("kv", "Embedded", "STM32, ESP32, ROS2, RTOS"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "98% defect detection accuracy \u2014 VisionGuard"),
    ("bul", "Reverse-engineered Atlas Copco CIP protocol"),
]
